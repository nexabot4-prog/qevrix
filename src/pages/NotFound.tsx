...
export function NotFound() {
  ...
  return (
    <div
      ...
      style={{ background: "#0A0A0A", minHeight: "100vh", color: "#fff", position: "relative" }}
    >
      <ScrollProgress />
      <Nav />
      ...
      >
        ...
        <img
          ...
          style={{ height: 48, width: "auto", objectFit: "contain", marginBottom: 48, opacity: 0.8 }}
        />
        {/* Light-mode text logo replacement */}
        <span
          className="qx-logo-text font-display font-bold"
          aria-hidden="true"
          style={{ fontSize: 32, letterSpacing: "-0.04em", marginBottom: 48, opacity: 0.8 }}
        >
          Q<span className="qx-letter">X</span>
        </span>

        {/* Ghost 404 */}
        <div
          className="glitch-404 error-number"
          aria-label="404"
          style={{
        ...
        <h1
          ...
          style={{ fontSize: 24, fontWeight: 400, color: "#fff", marginBottom: 12 }}
        >
          This system doesn't exist.
        </h1>
        <p
          className="error-sub"
          style={{ fontSize: 14, lineHeight: 1.7, color: "rgba(255,255,255,0.4)", maxWidth: 400, marginBottom: 40 }}
        >
